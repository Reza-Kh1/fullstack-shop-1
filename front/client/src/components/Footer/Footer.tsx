    ...
    <>
      <div className="flex w-full justify-evenly">
        <div className="double-line w-full relative">
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black dark:bg-slate-300 px-3">
      ...
      <footer className="w-full max-width py-5 px-3">
